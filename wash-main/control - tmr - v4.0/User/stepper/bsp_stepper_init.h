...
#define MOTOR_DIR_GPIO_CLK_ENABLE()   	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA,ENABLE)

//Motor 使能 
#define MOTOR_EN_PIN                  	GPIO_Pin_5
#define MOTOR_EN_GPIO_PORT            	GPIOA                       
#define MOTOR_EN_GPIO_CLK_ENABLE()    	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA,ENABLE)
...
#define MOTOR_PUL_GPIO_CLK_ENABLE()		  RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA,ENABLE)
